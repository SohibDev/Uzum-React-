  ...
  return (
		...
		<div className="container">
			...
			<div className="row">
				<div className="col-3 d-flex justify-content-between">
					<span className="fs-6">
						<img src="https://img.icons8.com/pastel-glyph/20/null/place-marker--v1.png" />
						<span className="text-secondary fs-6">City:</span> Tashkent
					</span>
					<span className="fs-6">
						Pickup Points
					</span>
				</div>
				<div className="col-3 fs-6 text-secondary mx-auto">
					Buyurtmangizni bir kunda yetkazib beramiz
				</div>
				<div className="col-4 row">
					<div className="col-4 text-secondary fs-6">Savol-javoblar</div>
					<div className="col-4 text-secondary fs-6">Buyurtmalarim</div>
					<div className="col-4 text-secondary fs-6">
						<select name="" id="language-select">
							<option className="active" value="uz">O'zbekcha</option>
	...
	<div className="container pt-3">
		...
		<header className="header">
			<div className="row header__top d-flex align-items-center justify-content-between pb-3">
				<svg className="col-2" xmlns="http://www.w3.org/2000/svg" width="215" height="32" viewBox="0 0 215 32" fill="none">
				...
				<div className="col-1 catalog rounded">
					<div className="d-flex align-items-center gap-2">
						<i className="fa fa-list text-primary fs-5"></i>
						<span className="fs-6 text-primary">Katalog</span>
					</div>
				</div>
				<div className="col-5 Input-container d-flex float-lg-end">
					<input type="search" className="form-control" name=""
						placeholder="Mahsulot va turkumlar izlash" id="search" />
					<button type="submit">
						<i className="fa fa-search"></i>
					</button>
				</div>
				<div className="col-4">
					<ul className="d-flex align-items-center float-end header-left fs-6 text-dark">
						<li className="list-group-item">
							<button id="login-btn" >Kirish</button>
						</li>
						<li className="list-group-item"><a className="text-dark"><img
									src="https://img.icons8.com/ios-glyphs/20/null/hearts.png" /> Saralangan</a></li>
						<li id="admin" style={{display: 'none'}} className="list-group-item"><a className="text-dark" > Admin</a></li>
						<li className="list-group-item cursor-pointer"><img
								src="https://img.icons8.com/ios/18/null/shopping-bag--v1.png" /> Savat</li>
					</ul>
				</div>
			</div>
			<div className="header__bottom">
				<ul id="categories" className="d-flex gap-3 fs-6 text-secondary justify-content-between">
					{/* <!-- <li className="list-group-item">Elektronika</li> --> */}
